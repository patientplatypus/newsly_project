...
export const testButtonAction = ({ commit }) => {
  ...
  axios.get('http://newslyproduction15.m28mgmyx2v.us-west-2.elasticbeanstalk.com:4000/api/articles')
  .then(response=>{
...
export const getUserObj = ({ commit }, { username, password }) => {
  ...
  axios.get('http://newslyproduction15.m28mgmyx2v.us-west-2.elasticbeanstalk.com:4000/api/user', {
    params: {
      username: username,
      password: password
    }
...
export const getArticleComments = ({ commit }, {id}) => {
  axios.get('http://newslyproduction15.m28mgmyx2v.us-west-2.elasticbeanstalk.com:4000/api/articles/'+id)
  .then(response=>{
