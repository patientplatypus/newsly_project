...
export const testButtonAction = ({ commit }) => {
  ...
  axios.get('http://newslyproject2318.us-west-2.elasticbeanstalk.com:80/api/articles')
  .then(response=>{
...
export const getUserObj = ({ commit }, { username, password }) => {
  ...
  axios.get('http://newslyproject2318.us-west-2.elasticbeanstalk.com:80/api/user', {
    params: {
      username: username,
      password: password
    }
...
export const getArticleComments = ({ commit }, {id}) => {
  axios.get('http://newslyproject2318.us-west-2.elasticbeanstalk.com:80/api/articles/'+id)
  .then(response=>{
